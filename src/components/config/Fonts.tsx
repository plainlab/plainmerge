...
const FontConfig = () => {
  return (
    <section className="h-full p-8 space-y-8 overflow-scroll bg-gray-50">
      ...
      <ul className="flex flex-col items-center justify-start flex-1 space-y-8 truncate bg-gray-50">
        <li className="flex items-center justify-start w-full p-4 space-x-4 transition-shadow bg-gray-100 border shadow-sm hover:shadow-md rounded-xl">
